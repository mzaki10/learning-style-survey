...
function showResults() {
  ...
  if (selectedOption) {
    ...
    const visualPercentage = calculatePercentage("visual");
    const auditoryPercentage = calculatePercentage("auditory");
    const tactilePercentage = calculatePercentage("tactile");
...
function calculatePercentage(learningStyle) {
  const styleCount = userResponses.filter(response => response === learningStyle).length;
